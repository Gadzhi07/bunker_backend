...
def _get_character_card_type_enum():
    return postgresql.ENUM('profession', 'biology', 'health', 'hobby', 'baggage', 'facts', 'phobia', 'character_trait', name='character_card_type_enum')
...
def upgrade() -> None:
    ...
    character_card_type = _get_character_card_type_enum()
    ...
    sa.Column('card_type', character_card_type, nullable=False),
    ...
    sa.Column('bunker_card_type', bunker_card_type, nullable=False),
    ...
    sa.Column('type_of_card_to_open', character_card_type, nullable=True),
    sa.ForeignKeyConstraint(['game_id'], ['games.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade() -> None:
    ...
    _get_character_card_type_enum().drop(op.get_bind())
